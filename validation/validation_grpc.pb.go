...
const (
	Validation_Validate_FullMethodName = "/validation.Validation/Validate"
)
...
type ValidationClient interface {
	Validate(ctx context.Context, in *ValidationRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *validationClient) Validate(ctx context.Context, in *ValidationRequest, opts ...grpc.CallOption) (*Empty, error) {
...
type ValidationServer interface {
	Validate(context.Context, *ValidationRequest) (*Empty, error)
...
func (UnimplementedValidationServer) Validate(context.Context, *ValidationRequest) (*Empty, error) {
