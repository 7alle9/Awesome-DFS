...
const (
	Dispatcher_Dispatch_FullMethodName = "/dispatcher.Dispatcher/Dispatch"
)
...
type DispatcherClient interface {
	Dispatch(ctx context.Context, in *Chunk, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *dispatcherClient) Dispatch(ctx context.Context, in *Chunk, opts ...grpc.CallOption) (*Response, error) {
...
type DispatcherServer interface {
	Dispatch(context.Context, *Chunk) (*Response, error)
...
func (UnimplementedDispatcherServer) Dispatch(context.Context, *Chunk) (*Response, error) {
...
func _Dispatcher_Dispatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DispatcherServer).Dispatch(ctx, req.(*Chunk))
	}
